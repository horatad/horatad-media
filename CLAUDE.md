...
- **Shorts แนวตั้ง 1080×1920 (YouTube · มาตรฐาน `SHORTS_TEMPLATE.md`) — เสร็จ+ขึ้น Drive:** `Shorts60` ปโตเลมี→พระเคราะห์ทั้งเก้า (`260615 Ptolemy Shorts`) · `TwoSystemsVert` Epicycle-vs-Helio (`260615 Epicycle vs Heliocentric Vert`) — มี voiceover ไทย+caption+bgm+credit · component (`Caption/Narration/Music/Credit`) รับ prop `timing` → reuse คลิปถัดไป
- **▶ ค้าง: migrate คลิปเก่าเหลืออีก ~5 เป็นแนวตั้ง** (MercuryRetro/VenusBrightest/EclipseStory/Opposition/MoonPhase/VenusPhase) ตามมาตรฐาน Shorts
