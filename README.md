...
├── FB-output/                 staging คลิป .mp4 + .docx (gitignored → ขึ้น Drive horatad-media)
...
- backup คลิป: คัดลอกขึ้น `G:\My Drive\horatad-media\YYMMDD <ชื่อ>\` (Google Drive for Desktop)
