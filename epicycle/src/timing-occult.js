...
// DUR วัดจากเสียงจริง public/vo-occult/ (ceil(sec*30)) · เสียงโหราทาส F5 @0.92 (re-render 27 มิ.ย. 69)
const DUR=[132,147,102,119,173,152,85,109,135,115,171];
const GAP=5, INTRO=150;
const TEXT=[
