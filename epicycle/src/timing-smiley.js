...
const DUR = [111, 119, 134, 129, 86, 143, 98, 128, 113, 147, 161]; // เฟรม (วัดจริง ffprobe)
const GAP = 6;
const INTRO = 75;

const TEXT = [
  'ท้องฟ้า...ยิ้มให้เรา?',
  'ดาวสว่าง ๒ ดวง = ตา · พระจันทร์เสี้ยว = รอยยิ้ม',
  'ดวงตา = ดาวศุกร์ + ดาวพฤหัส (สว่างสุดบนฟ้า)',
  'เรียงใกล้กัน จนดูเป็นใบหน้ายิ้ม = "พระจันทร์ยิ้ม"',
  'แต่จริงๆ ทั้งสามไม่ได้อยู่ใกล้กันเลย!',
  'พระจันทร์ ๓๘๔,๐๐๐ กม. · ศุกร์–พฤหัส ไกลกว่าหลายร้อยเท่า',
  'แค่บังเอิญอยู่ "ทิศเดียวกัน" เมื่อมองจากโลก',
  'ไทยใกล้เส้นศูนย์สูตร พระจันทร์หงายเป็นเรือ = ยิ้มชัด',
  'รอยยิ้ม = ด้านสว่างของพระจันทร์ ที่หันรับแสงอาทิตย์',
